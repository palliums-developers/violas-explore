...
class ViolasClient():
    def __init__(self, url, faucet_file=None):
        self.client = Client.new(url=url, faucet_file=faucet_file)
        self.client.set_exchange_module_address(core_code_address())
        self.client.set_exchange_owner_address(association_address())
